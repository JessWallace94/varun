(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@styled-system/css'), require('@styled-system/should-forward-prop'), require('@styled-system/space'), require('@styled-system/color'), require('@emotion/styled'), require('@emotion/core'), require('react')) :
  typeof define === 'function' && define.amd ? define(['exports', '@styled-system/css', '@styled-system/should-forward-prop', '@styled-system/space', '@styled-system/color', '@emotion/styled', '@emotion/core', 'react'], factory) :
  ...
  var sx = function (props) { return css__default(props.sx)(props.theme); };

  var base = function (props) { return css__default(props.__css)(props.theme); };
  ...
  var variant = function (ref) {
    ...
    return css__default(css.get(theme, __themeKey + '.' + variant, css.get(theme, variant)));
  };
